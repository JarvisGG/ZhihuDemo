 ...
 */
public class DirectionalViewPager1 extends ViewPager {
...
//    private VerticalViewPagerCompat.DataSetObserver mObserver;
    ...
    public DirectionalViewPager1(Context context) {
        super(context);
        initViewPager();
    }

    public DirectionalViewPager1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
