package com.jarvis.zhihudemo.view.helper;
 ...
 * @create 2018/1/26 下午3:08
 * @changeRecord [修改记录] <br/>
 */

public class AnswerDragHelper {
    private static final String TAG = "AnswerDragHelper";
    ...
    private final AnswerDragHelper.Callback mCallback;
     ...
     */
    public static AnswerDragHelper create(ViewGroup forParent, AnswerDragHelper.Callback cb) {
        return new AnswerDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static AnswerDragHelper create(ViewGroup forParent, float sensitivity, AnswerDragHelper.Callback cb) {
        final AnswerDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private AnswerDragHelper(Context context, ViewGroup forParent, AnswerDragHelper.Callback cb) {
        if (forParent == null) {
