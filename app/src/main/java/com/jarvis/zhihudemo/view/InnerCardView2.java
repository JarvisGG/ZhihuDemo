...
public class InnerCardView2 extends FrameLayout {
    ...
    public InnerCardView2(Context context) {
        this(context, null);
    }

    public InnerCardView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InnerCardView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        bottomDragVisibleHeight = ExplosionUtils.dp2Px(150);
        bototmExtraIndicatorHeight = ExplosionUtils.dp2Px(200);
            ...
            public void onClick(View v) {
                ...
                if (state == STATE_CLOSE) {
                    ...
                    if (mDragHelper.smoothSlideViewTo(topView, originX, dragTopDest)) {
                        ViewCompat.postInvalidateOnAnimation(InnerCardView2.this);
                    }
                } else {
                    // 点击时为展开状态，直接进入详情页
                    gotoDetailActivity();
