...
public enum BlurUtils {
    ...
    private BlurUtils.BlurPolicy mPolicy;

    private BlurUtils(Context context) {
        this.mPolicy = BlurUtils.BlurPolicy.RS_BLUR;
    ...
    public Bitmap blur() {
        if (this.mBitmap == null) {
            ...
            if (this.mPolicy == BlurPolicy.FAST_BLUR) {
    ...
    public BlurUtils policy(BlurUtils.BlurPolicy policy) {
        this.mPolicy = policy;
        return this;
    }
