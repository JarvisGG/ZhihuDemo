 ...
 * <p>
 * By default, CustomItemTouchHelper moves the items' translateX/Y properties to reposition them. You can
...
public class CustomItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    static final String TAG = "CustomItemTouchHelper";
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new CustomItemTouchHelperGestureListener());
    }
    ...
    /**
     * Starts dragging the provided ViewHolder. By default, CustomItemTouchHelper starts a drag when a
     ...
     * <li>There must be a previous touch event that was reported to the CustomItemTouchHelper
     ...
     *                 mCustomItemTouchHelper.startDrag(viewHolder);
     *             }
     *             return false;
     *         }
     *     });
    ...
    /**
     * Starts swiping the provided ViewHolder. By default, CustomItemTouchHelper starts swiping a View
     ...
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * CustomItemTouchHelper is attached.</li>
     ...
     *         public boolean onTouch(View v, MotionEvent event) {
     *             if (MotionEvent.getActionMasked(event) == MotionEvent.ACTION_DOWN) {
     *                 mCustomItemTouchHelper.startSwipe(viewHolder);
     *             }
     *             return false;
     *         }
     *     });
    ...
    public void startSwipe(ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start swipe has been called with a view holder which is not a child of "
                    + "the RecyclerView controlled by this CustomItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
    ...
    /**
     * This class is the contract between CustomItemTouchHelper and your application. It lets you control
     ...
     * {@link SimpleCallback}.
     * <p>
     * If user drags an item, CustomItemTouchHelper will call
    ...
    public abstract static class Callback {
         ...
         * swiping.
         *
         * @param recyclerView The RecyclerView to which CustomItemTouchHelper is attached.
        ...
        /**
         * Returns whether CustomItemTouchHelper should start a drag and drop operation if an item is
         * long pressed.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * dragging on a custom view touch using {@link #startDrag(ViewHolder)}.
         *
         * @return True if CustomItemTouchHelper should start dragging an item when it is long pressed,
        ...
        /**
         * Returns whether CustomItemTouchHelper should start a swipe operation if a pointer is swiped
         * over the View.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(ViewHolder)}.
         *
         * @return True if CustomItemTouchHelper should start swiping an item when user swipes a pointer
         ...
         * dragged. After a view is moved this amount, CustomItemTouchHelper starts checking for Views
         ...
         * Keep in mind that CustomItemTouchHelper also checks the perpendicular velocity and makes sure
        ...
        /**
         * Defines the maximum velocity CustomItemTouchHelper will ever calculate for pointer movements.
         * <p>
         * To consider a movement as swipe, CustomItemTouchHelper requires it to be larger than the
         ...
         *
         * @param defaultValue The default value(in pixels per second) used by the CustomItemTouchHelper.
         ...
         * <p>
         * CustomItemTouchHelper will keep a reference to the View until it is detached from
         * RecyclerView.
         * As soon as it is detached, CustomItemTouchHelper will call
        ...
        /**
         * Called when the ViewHolder swiped or dragged by the CustomItemTouchHelper is changed.
         * <p/>
        ...
        /**
         * Called by the CustomItemTouchHelper when the user interaction with an element is over and it
         ...
         *
         * @param recyclerView The RecyclerView which is controlled by the CustomItemTouchHelper.
        ...
        /**
         * Called by CustomItemTouchHelper on RecyclerView's onDraw callback.
         * <p>
         ...
         * <code>dY</code>.
         * CustomItemTouchHelper also takes care of drawing the child after other children if it is being
        ...
        /**
         * Called by the CustomItemTouchHelper when user action finished on a ViewHolder and now the View
         ...
         *
         * @param recyclerView  The RecyclerView to which the CustomItemTouchHelper is attached to.
     ...
     *
     * <pre>
     * CustomItemTouchHelper mIth = new CustomItemTouchHelper(
     *     new CustomItemTouchHelper.SimpleCallback(CustomItemTouchHelper.UP | CustomItemTouchHelper.DOWN,
    ...
    private class CustomItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {

        CustomItemTouchHelperGestureListener() {
        }
